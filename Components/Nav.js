...
const Nav = () => {
  ...
  return (
    <div className='h-24 bg-gradient-to-r from-bg_custom_3 to-bg_custom_2 ... flex justify-between items-center px-16'>
        ...
        <div className='font-roboto text-xs pl-3'><Link href="/">HOME</Link></div>
        <div className='font-roboto text-xs'><Link href="/portfolio">PORTFOLIO</Link></div>
        <div className='font-roboto text-xs'><Link href="/about">ABOUT</Link></div>
        <div className='font-roboto text-xs'><Link href="/contact">CONTACT</Link></div>
        </div>
